...
| 被测路由器编号 | 接口 | IP 地址       |
| -------------- | ---- | ------------- |
| 0              | 0    | `2a0e:aa06:497:ff02::2/64` |
| 0              | 1    | `2a0e:aa06:497:ff00::1/64` |
| 0              | 2    | `2a0e:aa06:497:2::1/64` |
| 0              | 3    | `2a0e:aa06:497:3::1/64` |
| 1              | 0    | `2a0e:aa06:497:ff00::2/64` |
| 1              | 1    | `2a0e:aa06:497:ff01::1/64` |
| 1              | 2    | `2a0e:aa06:497:102::1/64` |
| 1              | 3    | `2a0e:aa06:497:103::1/64` |
| 2              | 0    | `2a0e:aa06:497:ff01::2/64` |
| 2              | 1    | `2a0e:aa06:497:ff02::1/64` |
| 2              | 2    | `2a0e:aa06:497:202::1/64` |
| 2              | 3    | `2a0e:aa06:497:203::1/64` |

将三个被测路由器与三个测试主机如上图所示相连，然后进行如下测试：

* 连通性：首先在 PC0 上运行 `ping -c 5 2a0e:aa06:497:102::2` ，然后运行 `sudo ping -c 1000 -i 0.01 2a0e:aa06:497:102::2` 。然后在 PC0 上运行 `ping -c 5 2a0e:aa06:497:202::2` ，接着运行 `sudo ping -c 1000 -i 0.01 2a0e:aa06:497:202::2` 。最后在 PC1 上运行 `ping -c 5 2a0e:aa06:497:202::2` ，接着运行 `sudo ping -c 1000 -i 0.01 2a0e:aa06:497:202::2` 。若上述三种情况后一命令丢包率均不超过 1‰ 则认定被测路由器在该拓扑下连通。测试时注意观察 hop limit（下同）。
...
* 连通性：首先在 PC0 上运行 `ping -c 3 2a0e:aa06:497:101::2` ，然后运行 `sudo ping -c 1000 -i 0.01 2a0e:aa06:497:101::2` 。然后在 PC0 上运行 `ping -c 3 2a0e:aa06:497:201::2` ，接着运行 `sudo ping -c 1000 -i 0.01 2a0e:aa06:497:201::2` 。最后在 PC1 上运行 `ping -c 3 2a0e:aa06:497:201::2` ，接着运行 `sudo ping -c 1000 -i 0.01 2a0e:aa06:497:201::2` 。若上述三种情况后一命令丢包率均不超过 1‰ 则认定被测路由器在该拓扑下连通。
