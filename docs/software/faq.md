...
!!! question "我的程序在真机实验中，stdout 显示是空的，即使我程序一开始就输出了内容？"
...
!!! question "我用在本地用 netns 和 veth 搭建好了网络，也可以完成所要求的测试，但是在在线评测的时候不能通过，这可能是为什么呢？"
...
!!! question "在平台上真机实验时，看到日志里提示 `failed to disable ipv6 of interface xxx`，是否正常？"
