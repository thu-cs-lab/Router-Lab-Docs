...
编程作业：校历第 5 周-第 9 周周日（11 月 15 日）22 点
真机评测（单人）：校历第 10 周-第 12 周周日（12 月 6 日）22 点
真机评测（组队）：校历第 13 周-第 15 周周日（12 月 27 日）22 点

以上截止时间都以东八区（UTC+8）为准。在截止事件之前，你需要提交代码、完成评测并且标记最终提交。如果不标记最终提交，则以截止时间前最后一次评测结果为准。补交的惩罚措施尚未确定。
